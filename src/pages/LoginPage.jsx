  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isSignUp) {
        ...
        const signupResp = await fetch("http://ec2-3-110-105-91.ap-south-1.compute.amazonaws.com:8080/users/insert", {
          method: "POST",
        ...
        const loginResp = await fetch("http://ec2-3-110-105-91.ap-south-1.compute.amazonaws.com:8080/users/signin", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            email: formData.email,
        ...
        if (code === "200" && token) {
          ...
          try {
            const usernameResp = await fetch("http://ec2-3-110-105-91.ap-south-1.compute.amazonaws.com:8080/users/getusername", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
